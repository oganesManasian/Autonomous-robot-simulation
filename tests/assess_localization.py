...
# For saving experiment data
EXPERIMENT_RESULT_FOLDER = "experiments"
EXPERIMENT_FILENAME = "localization_data_"
...
def save_data():
    data = {"estimated_positions": ESTIMATED_POSITIONS, "true_positions": TRUE_POSITIONS, "differences": DIFFERENCES, "experiment_name": EXPERIMENT_NAME}
    ...
    if os.path.isdir(EXPERIMENT_RESULT_FOLDER):
        ...
        if existing_experiments:
            last_experiment_filename = int(last_experiment_filename.split(".")[0].split("_")[-1])[-1]
...
while not rospy.is_shutdown():
    try:
        ...
        ESTIMATED_POSITIONS.append(estinated_position)
        ...
        TRUE_POSITIONS.append(ground_truth_position)
